...
export default function FirstFrameSpecialties({
  suggestions = [],
  onSelectQuestion,
  proEnabled = false,
  onUpgrade,
    ...
    <section className="space-y-4">
      <header className="text-center">
        ...
        <p className="text-muted mt-1 text-sm">
          Prompts e diretrizes específicos por área (Cardio, Endócrino, Neuro, Derma etc.). Contexto brasileiro.
        </p>
        <div className="mt-2 text-[12.5px] text-muted">Diretrizes nacionais + grandes periódicos • Evidência &gt; 97%</div>
      </header>

{!proEnabled && (
  <PremiumGate enabled={false} onUpgrade={onUpgrade} modeLabel="Especialidades" />
)}
